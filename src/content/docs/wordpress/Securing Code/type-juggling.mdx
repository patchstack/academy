...
Always use strict comparison instead of loose comparison to prevent the risks of type juggling. Below example showcases how using `!==` fixes type juggling issue.
