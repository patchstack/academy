...
If there is no proper permission check while installing the plugins, it can lead to Remote Code Execution. An attacker can just create a malicious ZIP and provide it as the source to install the webshell in the WP site.
